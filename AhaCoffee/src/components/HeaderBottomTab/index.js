...
const HeaderBottomTab = props => {
  ...
  return (
    <View style={{backgroundColor:Colors.BLUE_MAIN}}>
      {/* {Platform.OS === 'ios' ? (
      ...
      <View style={styles.header}>
        ...
        <View
          ...
          <Text style={[styles.txtHeader, { marginLeft: backBtnEnable ?30:0}]}>{textHeader}</Text>
        </View>
...
const HeaderShowNavigation = withNavigation(HeaderBottomTab);
